...
#******************************************************************************
# 
#  Name:     generate_zeitreihen_zoomlevel15_1965_2010_config.py
#  Project:  BGDI Zeitreihen
#  Purpose:  Utility to create tilecache cfg files for requested years
#  Author:   Clausen Marcel / gud
# 
#******************************************************************************
#  
#  Verwendung/Zweck:
#  + Benutzt config template tilecache.swisstopo.zeitreihen.zoomlevel15.1965-2010.YYYY.cfg
...
if __name__ == '__main__':
    ...
    # Variablen
    ################################
    template = 'tilecache.swisstopo.zeitreihen.zoomlevel15.1965-2010.YYYY.cfg'
    output = ''
    ...
    python generate_zeitreihen_zoomlevel15_1954_1964_config.py -f 1850 -t 1900
    
    Beispiel 2: Generiere ein bash Script zur Tilegenerierung
    python generate_zeitreihen_zoomlevel15_1954_1964_config.py -f 1850 -t 1900 -l ch.swisstopo.zeitreihen
    \n"""
    ...
    if options.layer:
        ...
        for layer in options.layer.split(","):
            ...
            for year in range(year_from,year_to):
                output += "buildout/bin/tilemanager -t 64 -c etc/ch.swisstopo.zeitreihen/tilecache.swisstopo.zeitreihen.zoomlevel15.1965-2010.%s.cfg %s 15 20 -b 655000,194000,672500,206000\n" % (year,layer)
            output +="\n# Start tile generation for layer %s ...\n" % layer
            for year in range(year_from,year_to):
                output += "buildout/bin/tilemanager -t 64 -c etc/ch.swisstopo.zeitreihen/tilecache.swisstopo.zeitreihen.zoomlevel15.1965-2010.%s.cfg %s 15 20\n" % (year,layer)
            output +="\n\n"
        print output
