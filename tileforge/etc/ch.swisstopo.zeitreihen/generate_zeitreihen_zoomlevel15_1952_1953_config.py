...
#******************************************************************************
# 
#  Name:     generate_zeitreihen_zoomlevel15_1952_1953_config.py
...
#  
#  Verwendung/Zweck:
#  + Benutzt config template tilecache.swisstopo.zeitreihen.zoomlevel15.1952-1953.YYYY.cfg
...
if __name__ == '__main__':
    ...
    # Variablen
    ################################
    template = 'tilecache.swisstopo.zeitreihen.zoomlevel15.1952-1953.YYYY.cfg'
    output = ''
    ...
    python generate_zeitreihen_zoomlevel15_1952_1953_config.py -f 1850 -t 1900
    
    Beispiel 2: Generiere ein bash Script zur Tilegenerierung
    python generate_zeitreihen_zoomlevel15_1952_1953_config.py -f 1850 -t 1900 -l ch.swisstopo.zeitreihen
    \n"""
